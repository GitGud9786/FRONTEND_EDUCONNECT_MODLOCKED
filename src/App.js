...
import AdminTeacherCourseEnrollment from "./Components/AdminTeacherCourseEnrollment";
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin/teachercourseenroll" element={<AdminTeacherCourseEnrollment />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
